    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('kode_arah_angin') ?>"><i class="fa fa-edit"></i> Pengkodean Cuaca</a></li>
            <li><a href="<?php echo base_url('rule_base') ?>"><i class="fa fa-edit"></i> Rule Base</a></li>        
          </ul>
        </li>
        
        <li>
          <a href="<?php echo base_url('prediksi') ?>">
            <i class="fa fa-cloud"></i> <span>Prediksi</span>
          </a>
        </li>
